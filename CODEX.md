# CalBizHR — Instructions for Codex CLI

Standing instructions for any agent session working this repo via Codex. First time working on this
...
1. **Branch, don't push directly.** Create `agent/codex-[task-number]` off `phase-1-foundation`, work
