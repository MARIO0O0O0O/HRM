...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes: { path: string; priority: number; changeFreq: MetadataRoute.Sitemap[number]['changeFrequency'] }[] = [
    ...
    { path: '/programs/harassment-prevention', priority: 0.8, changeFreq: 'monthly' },
    { path: '/programs/harassment-prevention/policy-templates', priority: 0.6, changeFreq: 'monthly' },
    { path: '/programs/harassment-prevention/training', priority: 0.6, changeFreq: 'monthly' },
