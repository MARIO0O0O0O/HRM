...
export const metadata: Metadata = {
  ...
  description: 'California immediate final paycheck requirements (LC §201/202), Waiting Time Penalty rules (LC §203), and separation documentation.',
}
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-serif font-bold text-white tracking-tight">
            Terminations & Final Pay (LC §§201–203)
          </h1>
          <p className="text-base font-sans text-zinc-300 leading-relaxed">
            Immediate final wage payment timelines, accrued PTO payout calculation, Waiting Time Penalty prevention, and separation documents.
          </p>
        </div>
        ...
        <div className="p-8 bg-[#0f1c32] border border-[#B5933C]/30 rounded-2xl space-y-4 text-center">
          ...
          <p className="text-sm font-sans text-zinc-300 max-w-xl mx-auto leading-relaxed">
            Full compliance content for Terminations & Final Pay — including final check calculators, separation notice templates, and severance agreement checklists — will be integrated here in Phase 3.
          </p>
