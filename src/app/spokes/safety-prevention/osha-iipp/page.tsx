...
export const metadata: Metadata = {
  ...
  description: 'California Injury & Illness Prevention Program (IIPP) core mandates, hazard inspections, and heat illness prevention rules.',
}

export default function OshaIippProgramPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-serif font-bold text-white tracking-tight">
            Cal/OSHA IIPP & Heat Illness (Title 8 CCR §3203)
          </h1>
          <p className="text-base font-sans text-zinc-300 leading-relaxed">
            The 8 core safety program elements, hazard evaluation, safety communications, and indoor/outdoor heat illness prevention procedures.
          </p>
        </div>
        ...
        <div className="p-8 bg-[#0f1c32] border border-[#B5933C]/30 rounded-2xl space-y-4 text-center">
          ...
          <p className="text-sm font-sans text-zinc-300 max-w-xl mx-auto leading-relaxed">
            Full compliance content for Cal/OSHA IIPP — including written safety plans, hazard audit forms, and heat illness protocol guides — will be integrated here in Phase 3.
          </p>
