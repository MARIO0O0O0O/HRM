...
export const metadata: Metadata = {
  ...
  description: 'California meal and rest break timing rules, attestation workflows, and premium pay requirements.',
}

export default function MealRestBreaksProgramPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="space-y-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-serif font-bold text-white tracking-tight">
            Meal & Rest Breaks (LC §226.7 / §512)
          </h1>
          <p className="text-base font-sans text-zinc-300 leading-relaxed">
            Statutory break scheduling mandates, meal break waivers, rest break logs, and premium pay compliance.
          </p>
        </div>
        ...
        <div className="p-8 bg-[#0f1c32] border border-[#B5933C]/30 rounded-2xl space-y-4 text-center">
          ...
          <p className="text-sm font-sans text-zinc-300 max-w-xl mx-auto leading-relaxed">
            Full compliance content for Meal & Rest Breaks — including break attestation systems, waiver agreements, and premium pay calculation guides — will be integrated here in Phase 3.
          </p>
