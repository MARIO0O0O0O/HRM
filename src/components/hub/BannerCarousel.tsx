...
export default function BannerCarousel() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-2.5 sm:py-3 flex flex-col justify-between min-h-[64px] sm:min-h-[72px]">
        {/* Banner Content Container */}
        <Link
          href={currentAd.href}
          className="group flex items-center justify-between gap-3 text-left focus:outline-none focus:ring-1 focus:ring-[#B5933C] rounded-lg p-1 transition-all"
        >
          <div className="flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-3 overflow-hidden">
            <div className="flex items-center gap-2 shrink-0">
              <span className="inline-flex items-center gap-1 text-xs font-mono font-bold uppercase tracking-wider text-[#B5933C] bg-[#B5933C]/10 border border-[#B5933C]/30 px-2 py-0.5 rounded-full">
            ...
            <div className="flex flex-col min-w-0">
              ...
              <p className="text-xs font-sans text-zinc-300 truncate leading-snug">
                {currentAd.subtitle}
              </p>
            </div>
          </div>
