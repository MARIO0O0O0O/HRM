...
export default function HubGrid() {
  ...
  return (
    <div className="h-[calc(100dvh-var(--header-height,64px))] max-h-[calc(100dvh-var(--header-height,64px))] w-full flex flex-col bg-[#1A2D4D] text-zinc-100 overflow-hidden select-none">
      ...
      {/* Main 6-Tile Hub Grid (2x3 on Mobile, 3x2 on Desktop, Zero-Scroll 100dvh with Reserved Drawer Gutter) */}
      <main className="flex-1 pl-12 pr-2.5 sm:pl-16 sm:pr-4 py-2 sm:py-3 grid grid-cols-2 md:grid-cols-3 grid-rows-3 md:grid-rows-2 gap-2 sm:gap-3.5 overflow-hidden">
        {hubTiles.map((tile) => {
          ...
          return (
            ...
            >
              ...
              {/* Solid Notch Label Area (High Legibility Dark Parchment Box) */}
